...
This tutorial will guide you through the process of creating an LLM Chatbot using ICP Ninja and the LLM Canister. 

It is divided into 3 sections 
1. [Introduction to ICP Ninja]() 
2. [Introduction to LLM Canister]() 
3. [Create an LLM Chatbot using ICP Ninja & LLM Canister]() 
...
Then get started coding! All without having to do a million configurations and setups

Note that deployed projects remain active for 20 minutes but can be redeployed as needed. For long-term development, you'll want to migrate to a local environment.
